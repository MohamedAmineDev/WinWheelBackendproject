...
public class ApplicationSecurityConfigurations extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                //.antMatchers(HttpMethod.PUT, "/app/api/manage_user/update_user/**").hasRole(Roles.ROLE_ADMIN.getPermission())
                //.antMatchers(HttpMethod.PUT, "/app/api/manage_user/update_user/**").hasRole(Roles.ROLE_PLAYER.getPermission())
